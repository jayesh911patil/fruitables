            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span>Organic Veggies
                        </h4>
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h5 class="card-header">Organic Veggies</h5>
                                </div>
                                <div class="col-lg-6">
                                    <h5 class="card-header text-end ">
                                        <a href="{{route('add-organic-veggies')}}"
