            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span>Our Organic
                            Products
                        </h4>
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h5 class="card-header">Our Organic Products</h5>
                                </div>
                                <div class="col-lg-6">
                                    <h5 class="card-header text-end ">
                                        <a href="{{route('add-our-organic-products')}}"
                        ...
                        <script>
                            $(function () {
                                var table = $('.yajra-datatables').DataTable({
                                    processing: true,
                                    serverSide: true,
                                    ajax: "{{route('our-organic-products')}}",
                                    columns: [
                                        {
                                            data: 'DT_RowIndex',
                                            name: 'DT_RowIndex'
